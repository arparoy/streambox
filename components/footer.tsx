...
export default function Footer() {
  return (
    <footer className="border-t border-border-subtle mt-20 glassmorphism">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2">
              <Film className="w-6 h-6 text-primary" />
              <span className="text-lg font-bold tracking-tight text-foreground">Stream<span className="text-primary">Box</span></span>
            </Link>
          ...
          <div>
            <h3 className="font-semibold mb-4 text-foreground/90">Quick Links</h3>
        ...
        <div className="border-t border-border-subtle mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-foreground/40 max-w-xl text-center md:text-right">
